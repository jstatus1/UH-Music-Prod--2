            ...
            <React.Fragment>
                <div className="library_header mt-4">
                    ...
                    <div className="library_label_group">
                        ...
                        <Link to="/Library/Playlists"><button onClick={e=>{this.onClickFunction(e)}} value="playlist" className={`btn library_labels ${this.state.currentpage==("playlist")? 'active': null}`}>Playlists</button></Link>
                        <Link to="/Library/Albums"><button onClick={e=>{this.onClickFunction(e)}} value="album" className={`btn library_labels ${this.state.currentpage==("album")? 'active': null}`}>Albums</button></Link>
